...
HD_PWD='C:/Users/sosez/Logical_Design_Project/Term_Project/Term_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Roulette.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_Roulette.tcl -notrace
