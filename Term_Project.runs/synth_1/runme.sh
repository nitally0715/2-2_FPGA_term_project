...
HD_PWD='C:/Users/sosez/Logical_Design_Project/Term_Project/Term_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Roulette.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Roulette.tcl
